...
namespace OKComplex.Areas.Forum.Controllers
{
    public class AccountController : Controller
    {
        ...
        public ActionResult Logout()
        {
            ...
            Response.Cookies.Add(cookie_password);
            return Content("<script type=\"text/javascript\">$.OK.SuccessModal('Hesabınızdan çıkış yapılıyor..');setTimeout(function () { window.location.href = '" + Url.Action("Index", "Forum") + "'; }, 2000);</script>");
        }
        [SiteControl]
