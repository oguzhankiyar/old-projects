...
{
    class GameOverDialog : Grid
    {
        public static GameOverDialog Current { get; private set; }

        private GameOverDialog() { }

        public static void Create()
        {
            Current = new GameOverDialog();
            StackPanel sp = new StackPanel();
            sp.Children.Add(new TextBlock() { Text = LocalizedStrings.Get(LocalizedString.GameOver), Foreground = new SolidColorBrush(Colors.White), FontSize = 45, TextAlignment = TextAlignment.Center });
