...
{
    class StartDialog : Grid
    {
        public static StartDialog Current { get; private set; }

        private StartDialog() { }

        public static void Create()
        {
            Current = new StartDialog();
            StackPanel sp = new StackPanel();
            sp.Children.Add(new TextBlock() { Text = LocalizedStrings.Get(LocalizedString.StartPlaying), Foreground = new SolidColorBrush(Colors.White), FontSize = 45, TextAlignment = TextAlignment.Center });
